...
import com.android.ranging.RangingUtils.Conversions;
...
public abstract class UwbConfig {
    ...
    public static UwbConfig parseBytes(byte[] uwbConfigBytes) {
        ...
        ByteString sessionKey = ByteString.copyFrom(uwbConfigBytes, parseCursor, sessionKeyLength);
     ...
     * session key.
     */
    public abstract ByteString getSessionKey();
    ...
    public static Builder builder() {
        return new AutoValue_UwbConfig.Builder().setSessionKey(ByteString.EMPTY);
    }
    ...
    public abstract static class Builder {
        ...
        public abstract Builder setSessionKey(ByteString sessionKey);
